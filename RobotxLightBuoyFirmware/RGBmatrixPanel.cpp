...
void EnhancedRGBmatrixPanel::updateStaticDisplay(void) {
 ...
 /******   Interrupt value found through experimentation, had to balance speed vs. loss of brightness *****/
  ICR1      = 600; // Set interval for next interrupt (smaller than this and time in interupt vs time in listen loop becomes an issue
  TCNT1     = 0;        // Restart interrupt timer
